...
```text
classes.xsl              54384  33.24%
to-java.xsl              53540  32.73%
set-locators.xsl         12962  7.92%
set-original-names.xsl   9839   6.01%
attrs.xsl                8162   4.99%
data.xsl                 7646   4.67%
anonymous-to-nested.xsl  5816   3.56%
tests.xsl                5711   3.49%
package.xsl              5527   3.38%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-04-24 at 06:07,
on Linux with 4 CPUs.
The total is 163587 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/24874420766
